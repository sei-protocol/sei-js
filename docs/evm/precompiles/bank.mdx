...
- **[Distribution](/evm/precompiles/distribution)**: Claim staking rewards
- **[Staking](/evm/precompiles/staking)**: Delegate tokens to validators  
- **[IBC](/evm/precompiles/ibc)**: Transfer tokens cross-chain
