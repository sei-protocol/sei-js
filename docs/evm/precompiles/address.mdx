...
- **[Bank](/evm/precompiles/bank)**: Transfer tokens between associated addresses
- **[IBC](/evm/precompiles/ibc)**: Cross-chain transfers using address mapping
- **[Staking](/evm/precompiles/staking)**: Delegate from associated addresses
