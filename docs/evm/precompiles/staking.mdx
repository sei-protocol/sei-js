...
- **[Distribution](/evm/precompiles/distribution)**: Claim staking rewards from delegations
- **[Bank](/evm/precompiles/bank)**: Check SEI balance before delegating
- **[Governance](/evm/precompiles/governance)**: Participate in network governance
