...
- **[Oracle](/evm/precompiles/oracle)**: Use with oracle data for price feeds
- **[IBC](/evm/precompiles/ibc)**: Process cross-chain transaction data
- **[Bank](/evm/precompiles/bank)**: Parse token metadata and balance information
