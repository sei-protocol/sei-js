...
docs://sei-js/precompiles/overview
docs://sei-js/cosmos/integration
docs://sei-js/sei-global-wallet/setup

# Function-specific docs
docs://sei-js/precompiles/bank/balance
docs://sei-js/examples/token-transfer
```

<Note>
The AI stays current with the latest @sei-js documentation and can help you implement features using the most up-to-date patterns and examples.
</Note>
