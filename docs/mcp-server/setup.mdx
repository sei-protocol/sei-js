  ...
  <Tab title="Claude CLI">
    ...
    <Steps>
      ...
      <Step title="Add Server">
        ...
        claude mcp add sei-mcp-server npx node@18 @sei-js/mcp-server
        
        # Wallet-enabled mode
        claude mcp add sei-mcp-server-wallet npx node@18 @sei-js/mcp-server --env WALLET_MODE=private-key PRIVATE_KEY=0x123...
        ```
      </Step>
