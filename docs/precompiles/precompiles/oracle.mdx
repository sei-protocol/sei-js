...
- **[Bank](/evm/precompiles/bank)**: Query token balances and metadata
- **[Staking](/evm/precompiles/staking)**: Validator and delegation information
- **[Governance](/evm/precompiles/governance)**: Proposal and voting data
