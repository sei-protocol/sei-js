...
- **[Staking](/evm/precompiles/staking)**: Delegate tokens to earn rewards
- **[Bank](/evm/precompiles/bank)**: Check reward balances after claiming
- **[Governance](/evm/precompiles/governance)**: Participate in governance with staked tokens
