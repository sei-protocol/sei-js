...
- **[Bank](/evm/precompiles/bank)**: Check token balances before IBC transfers
- **[Address](/evm/precompiles/address)**: Convert between EVM and Cosmos addresses
- **[Oracle](/evm/precompiles/oracle)**: Get exchange rates for cross-chain arbitrage
