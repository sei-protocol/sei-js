...
const SHELL_WALLET: SupportedWallet = {
	windowKey: 'shellwallet'
};

export const SUPPORTED_WALLETS: SupportedWallet[] = [KEPLR_WALLET, LEAP_WALLET, COIN_98_WALLET, FALCON_WALLET, FIN_WALLET, COMPASS_WALLET, SHELL_WALLET];
