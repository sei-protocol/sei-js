...
export declare enum PositionDirectionSDKType {
    LONG = 0,
    SHORT = 1,
    UNRECOGNIZED = -1
}
...
export declare enum PositionEffectSDKType {
    OPEN = 0,
    CLOSE = 1,
    UNRECOGNIZED = -1
}
...
export declare enum UnitSDKType {
    STANDARD = 0,
    MILLI = 1,
    MICRO = 2,
    NANO = 3,
...
export declare enum OrderStatusSDKType {
    PLACED = 0,
    FAILED_TO_PLACE = 1,
    CANCELLED = 2,
    FULFILLED = 3,
...
export declare enum CancellationInitiatorSDKType {
    USER = 0,
    LIQUIDATED = 1,
    UNRECOGNIZED = -1
}
