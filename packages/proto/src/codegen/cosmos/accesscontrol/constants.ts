...
export const AccessOperationSelectorTypeSDKType = AccessOperationSelectorType;
export const AccessOperationSelectorTypeAmino = AccessOperationSelectorType;
...
export const ResourceTypeAmino = ResourceType;
...
export const WasmMessageSubtypeSDKType = WasmMessageSubtype;
export const WasmMessageSubtypeAmino = WasmMessageSubtype;
