...
export interface SigningInfoLegacyMissedHeightsAmino {
  ...
  address?: string;
  /** validator_signing_info represents the signing info of this validator. */
  validator_signing_info?: ValidatorSigningInfoLegacyMissedHeightsAmino | undefined;
}
...
export interface SigningInfoLegacyMissedHeightsSDKType {
  address: string;
  validator_signing_info: ValidatorSigningInfoLegacyMissedHeightsSDKType | undefined;
}
/**
...
export const GenesisStateLegacyMissingHeights = {
  typeUrl: "/cosmos.slashing.v1beta1.GenesisStateLegacyMissingHeights",
  encode(message: GenesisStateLegacyMissingHeights, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.params !== undefined) {
      Params.encode(message.params, writer.uint32(10).fork()).ldelim();
    }
    for (const v of message.signingInfos) {
...
export const GenesisStateLegacyV43 = {
  typeUrl: "/cosmos.slashing.v1beta1.GenesisStateLegacyV43",
  encode(message: GenesisStateLegacyV43, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.params !== undefined) {
      Params.encode(message.params, writer.uint32(10).fork()).ldelim();
    }
    for (const v of message.signingInfos) {
...
export const SigningInfoLegacyMissedHeights = {
  typeUrl: "/cosmos.slashing.v1beta1.SigningInfoLegacyMissedHeights",
  encode(message: SigningInfoLegacyMissedHeights, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    if (message.validatorSigningInfo !== undefined) {
