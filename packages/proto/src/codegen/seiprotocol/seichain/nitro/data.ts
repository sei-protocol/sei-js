...
function createBaseTransactionData(): TransactionData {
  return {
    ...
    legacyMessage: LegacyMessage.fromPartial({}),
    v0LoadedMessage: LoadedMessage.fromPartial({}),
    signatures: [],
    messageHash: "",
...
function createBaseLegacyMessage(): LegacyMessage {
  return {
    header: MessageHeader.fromPartial({}),
    accountKeys: [],
    recentBlockhash: "",
    instructions: []
  };
...
function createBaseLoadedMessage(): LoadedMessage {
  return {
    ...
    loadedAddresses: LoadedAddresses.fromPartial({})
  };
}
