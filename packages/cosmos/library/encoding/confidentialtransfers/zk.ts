...
export const registry: Array<[string, GeneratedType]> = [
	["/seiprotocol.seichain.confidentialtransfers.TransferMsgProofs", TransferMsgProofs as never],
	["/seiprotocol.seichain.confidentialtransfers.InitializeAccountMsgProofs", InitializeAccountMsgProofs as never],
	["/seiprotocol.seichain.confidentialtransfers.WithdrawMsgProofs", WithdrawMsgProofs as never],
	["/seiprotocol.seichain.confidentialtransfers.CloseAccountMsgProofs", CloseAccountMsgProofs as never],
	["/seiprotocol.seichain.confidentialtransfers.PubkeyValidityProof", PubkeyValidityProof as never],
	["/seiprotocol.seichain.confidentialtransfers.CiphertextValidityProof", CiphertextValidityProof as never],
	["/seiprotocol.seichain.confidentialtransfers.RangeProof", RangeProof as never],
	["/seiprotocol.seichain.confidentialtransfers.CiphertextCommitmentEqualityProof", CiphertextCommitmentEqualityProof as never],
	["/seiprotocol.seichain.confidentialtransfers.CiphertextCiphertextEqualityProof", CiphertextCiphertextEqualityProof as never],
	["/seiprotocol.seichain.confidentialtransfers.ZeroBalanceProof", ZeroBalanceProof as never]
];
export const aminoConverters = {
	"/seiprotocol.seichain.confidentialtransfers.TransferMsgProofs": {
		aminoType: "confidentialtransfers/TransferMsgProofs",
		toAmino: (message: TransferMsgProofs) => ({ ...message }),
		fromAmino: (object: TransferMsgProofs) => ({ ...object })
	},
	...
	"/seiprotocol.seichain.confidentialtransfers.InitializeAccountMsgProofs": {
		...
		toAmino: (message: InitializeAccountMsgProofs) => ({ ...message }),
		fromAmino: (object: InitializeAccountMsgProofs) => ({ ...object })
	},

	"/seiprotocol.seichain.confidentialtransfers.WithdrawMsgProofs": {
		aminoType: "confidentialtransfers/WithdrawMsgProofs",
		toAmino: (message: WithdrawMsgProofs) => ({ ...message }),
		fromAmino: (object: WithdrawMsgProofs) => ({ ...object })
	},

	"/seiprotocol.seichain.confidentialtransfers.CloseAccountMsgProofs": {
		aminoType: "confidentialtransfers/CloseAccountMsgProofs",
		toAmino: (message: CloseAccountMsgProofs) => ({ ...message }),
		fromAmino: (object: CloseAccountMsgProofs) => ({ ...object })
	},

	"/seiprotocol.seichain.confidentialtransfers.PubkeyValidityProof": {
		aminoType: "confidentialtransfers/PubkeyValidityProof",
		toAmino: (message: PubkeyValidityProof) => ({ ...message }),
		fromAmino: (object: PubkeyValidityProof) => ({ ...object })
	},
	...
	"/seiprotocol.seichain.confidentialtransfers.CiphertextValidityProof": {
		...
		toAmino: (message: CiphertextValidityProof) => ({ ...message }),
		fromAmino: (object: CiphertextValidityProof) => ({ ...object })
	},
	...
	"/seiprotocol.seichain.confidentialtransfers.CiphertextCommitmentEqualityProof": {
		...
		toAmino: (message: CiphertextCommitmentEqualityProof) => ({ ...message }),
		fromAmino: (object: CiphertextCommitmentEqualityProof) => ({ ...object })
	},

	"/seiprotocol.seichain.confidentialtransfers.CiphertextCiphertextEqualityProof": {
		aminoType: "confidentialtransfers/CiphertextCiphertextEqualityProof",
		toAmino: (message: CiphertextCiphertextEqualityProof) => ({ ...message }),
		fromAmino: (object: CiphertextCiphertextEqualityProof) => ({ ...object })
	},

	"/seiprotocol.seichain.confidentialtransfers.ZeroBalanceProof": {
		aminoType: "confidentialtransfers/ZeroBalanceProof",
		toAmino: (message: ZeroBalanceProof) => ({ ...message }),
		fromAmino: (object: ZeroBalanceProof) => ({ ...object })
	}
};
