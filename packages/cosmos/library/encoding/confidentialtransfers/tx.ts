...
export const registry: Array<[string, GeneratedType]> = [
	...
	["/seiprotocol.seichain.confidentialtransfers.MsgTransferResponse", MsgTransferResponse as never],
	["/seiprotocol.seichain.confidentialtransfers.Auditor", Auditor as never],
	["/seiprotocol.seichain.confidentialtransfers.MsgInitializeAccount", MsgInitializeAccount as never],
	["/seiprotocol.seichain.confidentialtransfers.MsgInitializeAccountResponse", MsgInitializeAccountResponse as never],
	["/seiprotocol.seichain.confidentialtransfers.MsgDeposit", MsgDeposit as never],
	["/seiprotocol.seichain.confidentialtransfers.MsgDepositResponse", MsgDepositResponse as never],
	["/seiprotocol.seichain.confidentialtransfers.MsgWithdraw", MsgWithdraw as never],
	["/seiprotocol.seichain.confidentialtransfers.MsgWithdrawResponse", MsgWithdrawResponse as never],
	["/seiprotocol.seichain.confidentialtransfers.MsgApplyPendingBalance", MsgApplyPendingBalance as never],
	["/seiprotocol.seichain.confidentialtransfers.MsgApplyPendingBalanceResponse", MsgApplyPendingBalanceResponse as never],
	["/seiprotocol.seichain.confidentialtransfers.MsgCloseAccount", MsgCloseAccount as never],
	["/seiprotocol.seichain.confidentialtransfers.MsgCloseAccountResponse", MsgCloseAccountResponse as never]
];
export const aminoConverters = {
	...
	"/seiprotocol.seichain.confidentialtransfers.MsgTransferResponse": {
		...
		toAmino: (message: MsgTransferResponse) => ({ ...message }),
		fromAmino: (object: MsgTransferResponse) => ({ ...object })
	},
	...
	"/seiprotocol.seichain.confidentialtransfers.MsgInitializeAccount": {
		...
		toAmino: (message: MsgInitializeAccount) => ({ ...message }),
		fromAmino: (object: MsgInitializeAccount) => ({ ...object })
	},
	...
	"/seiprotocol.seichain.confidentialtransfers.MsgInitializeAccountResponse": {
		...
		toAmino: (message: MsgInitializeAccountResponse) => ({ ...message }),
		fromAmino: (object: MsgInitializeAccountResponse) => ({ ...object })
	},
	...
	"/seiprotocol.seichain.confidentialtransfers.MsgWithdrawResponse": {
		...
		toAmino: (message: MsgWithdrawResponse) => ({ ...message }),
		fromAmino: (object: MsgWithdrawResponse) => ({ ...object })
	},

	"/seiprotocol.seichain.confidentialtransfers.MsgApplyPendingBalance": {
		aminoType: "confidentialtransfers/MsgApplyPendingBalance",
		toAmino: (message: MsgApplyPendingBalance) => ({ ...message }),
		fromAmino: (object: MsgApplyPendingBalance) => ({ ...object })
	},

	"/seiprotocol.seichain.confidentialtransfers.MsgApplyPendingBalanceResponse": {
		aminoType: "confidentialtransfers/MsgApplyPendingBalanceResponse",
		toAmino: (message: MsgApplyPendingBalanceResponse) => ({ ...message }),
		fromAmino: (object: MsgApplyPendingBalanceResponse) => ({ ...object })
	},

	"/seiprotocol.seichain.confidentialtransfers.MsgCloseAccount": {
		aminoType: "confidentialtransfers/MsgCloseAccount",
		toAmino: (message: MsgCloseAccount) => ({ ...message }),
		fromAmino: (object: MsgCloseAccount) => ({ ...object })
	},
	...
	"/seiprotocol.seichain.confidentialtransfers.MsgCloseAccountResponse": {
		...
		toAmino: (message: MsgCloseAccountResponse) => ({ ...message }),
		fromAmino: (object: MsgCloseAccountResponse) => ({ ...object })
	}
};
