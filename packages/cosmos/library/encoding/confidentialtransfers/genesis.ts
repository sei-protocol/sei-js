...
export const registry: Array<[string, GeneratedType]> = [
	["/seiprotocol.seichain.confidentialtransfers.GenesisState", GenesisState as never],
	["/seiprotocol.seichain.confidentialtransfers.GenesisCtAccount", GenesisCtAccount as never]
];
export const aminoConverters = {
	...
	"/seiprotocol.seichain.confidentialtransfers.GenesisCtAccount": {
		...
		toAmino: (message: GenesisCtAccount) => ({ ...message }),
		fromAmino: (object: GenesisCtAccount) => ({ ...object })
	}
};
