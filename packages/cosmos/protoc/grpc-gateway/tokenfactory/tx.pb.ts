...
export class Msg {
	static CreateDenom(req: MsgCreateDenom, initReq?: fm.InitReq): Promise<MsgCreateDenomResponse> {
		return fm.fetchReq<MsgCreateDenom, MsgCreateDenomResponse>(`/seiprotocol.seichain.tokenfactory.Msg/CreateDenom`, {
			...initReq,
			method: "POST",
	...
	static UpdateDenom(req: MsgUpdateDenom, initReq?: fm.InitReq): Promise<MsgUpdateDenomResponse> {
		return fm.fetchReq<MsgUpdateDenom, MsgUpdateDenomResponse>(`/seiprotocol.seichain.tokenfactory.Msg/UpdateDenom`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static Mint(req: MsgMint, initReq?: fm.InitReq): Promise<MsgMintResponse> {
		return fm.fetchReq<MsgMint, MsgMintResponse>(`/seiprotocol.seichain.tokenfactory.Msg/Mint`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static Burn(req: MsgBurn, initReq?: fm.InitReq): Promise<MsgBurnResponse> {
		return fm.fetchReq<MsgBurn, MsgBurnResponse>(`/seiprotocol.seichain.tokenfactory.Msg/Burn`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static ChangeAdmin(req: MsgChangeAdmin, initReq?: fm.InitReq): Promise<MsgChangeAdminResponse> {
		return fm.fetchReq<MsgChangeAdmin, MsgChangeAdminResponse>(`/seiprotocol.seichain.tokenfactory.Msg/ChangeAdmin`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static SetDenomMetadata(req: MsgSetDenomMetadata, initReq?: fm.InitReq): Promise<MsgSetDenomMetadataResponse> {
		return fm.fetchReq<MsgSetDenomMetadata, MsgSetDenomMetadataResponse>(`/seiprotocol.seichain.tokenfactory.Msg/SetDenomMetadata`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
