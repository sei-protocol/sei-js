...
export class Msg {
	...
	static RegisterPointer(req: MsgRegisterPointer, initReq?: fm.InitReq): Promise<MsgRegisterPointerResponse> {
		return fm.fetchReq<MsgRegisterPointer, MsgRegisterPointerResponse>(`/seiprotocol.seichain.evm.Msg/RegisterPointer`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static AssociateContractAddress(req: MsgAssociateContractAddress, initReq?: fm.InitReq): Promise<MsgAssociateContractAddressResponse> {
		return fm.fetchReq<MsgAssociateContractAddress, MsgAssociateContractAddressResponse>(`/seiprotocol.seichain.evm.Msg/AssociateContractAddress`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static Associate(req: MsgAssociate, initReq?: fm.InitReq): Promise<MsgAssociateResponse> {
		return fm.fetchReq<MsgAssociate, MsgAssociateResponse>(`/seiprotocol.seichain.evm.Msg/Associate`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
