...
type OneOf<T> = { [k in keyof T]?: undefined } | (keyof T extends infer K ? (K extends string & keyof T ? { [k in K]: T[K] } & Absent<T, K> : never) : never);
...
export class ABCIApplication {
	static Echo(req: RequestEcho, initReq?: fm.InitReq): Promise<ResponseEcho> {
		return fm.fetchReq<RequestEcho, ResponseEcho>(`/tendermint.abci.ABCIApplication/Echo`, {
			...initReq,
			method: "POST",
	...
	static Flush(req: RequestFlush, initReq?: fm.InitReq): Promise<ResponseFlush> {
		return fm.fetchReq<RequestFlush, ResponseFlush>(`/tendermint.abci.ABCIApplication/Flush`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static Info(req: RequestInfo, initReq?: fm.InitReq): Promise<ResponseInfo> {
		return fm.fetchReq<RequestInfo, ResponseInfo>(`/tendermint.abci.ABCIApplication/Info`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static CheckTx(req: RequestCheckTx, initReq?: fm.InitReq): Promise<ResponseCheckTx> {
		return fm.fetchReq<RequestCheckTx, ResponseCheckTx>(`/tendermint.abci.ABCIApplication/CheckTx`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static Query(req: RequestQuery, initReq?: fm.InitReq): Promise<ResponseQuery> {
		return fm.fetchReq<RequestQuery, ResponseQuery>(`/tendermint.abci.ABCIApplication/Query`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static Commit(req: RequestCommit, initReq?: fm.InitReq): Promise<ResponseCommit> {
		return fm.fetchReq<RequestCommit, ResponseCommit>(`/tendermint.abci.ABCIApplication/Commit`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static InitChain(req: RequestInitChain, initReq?: fm.InitReq): Promise<ResponseInitChain> {
		return fm.fetchReq<RequestInitChain, ResponseInitChain>(`/tendermint.abci.ABCIApplication/InitChain`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static ListSnapshots(req: RequestListSnapshots, initReq?: fm.InitReq): Promise<ResponseListSnapshots> {
		return fm.fetchReq<RequestListSnapshots, ResponseListSnapshots>(`/tendermint.abci.ABCIApplication/ListSnapshots`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static OfferSnapshot(req: RequestOfferSnapshot, initReq?: fm.InitReq): Promise<ResponseOfferSnapshot> {
		return fm.fetchReq<RequestOfferSnapshot, ResponseOfferSnapshot>(`/tendermint.abci.ABCIApplication/OfferSnapshot`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static LoadSnapshotChunk(req: RequestLoadSnapshotChunk, initReq?: fm.InitReq): Promise<ResponseLoadSnapshotChunk> {
		return fm.fetchReq<RequestLoadSnapshotChunk, ResponseLoadSnapshotChunk>(`/tendermint.abci.ABCIApplication/LoadSnapshotChunk`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static ApplySnapshotChunk(req: RequestApplySnapshotChunk, initReq?: fm.InitReq): Promise<ResponseApplySnapshotChunk> {
		return fm.fetchReq<RequestApplySnapshotChunk, ResponseApplySnapshotChunk>(`/tendermint.abci.ABCIApplication/ApplySnapshotChunk`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static PrepareProposal(req: RequestPrepareProposal, initReq?: fm.InitReq): Promise<ResponsePrepareProposal> {
		return fm.fetchReq<RequestPrepareProposal, ResponsePrepareProposal>(`/tendermint.abci.ABCIApplication/PrepareProposal`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static ProcessProposal(req: RequestProcessProposal, initReq?: fm.InitReq): Promise<ResponseProcessProposal> {
		return fm.fetchReq<RequestProcessProposal, ResponseProcessProposal>(`/tendermint.abci.ABCIApplication/ProcessProposal`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static ExtendVote(req: RequestExtendVote, initReq?: fm.InitReq): Promise<ResponseExtendVote> {
		return fm.fetchReq<RequestExtendVote, ResponseExtendVote>(`/tendermint.abci.ABCIApplication/ExtendVote`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static VerifyVoteExtension(req: RequestVerifyVoteExtension, initReq?: fm.InitReq): Promise<ResponseVerifyVoteExtension> {
		return fm.fetchReq<RequestVerifyVoteExtension, ResponseVerifyVoteExtension>(`/tendermint.abci.ABCIApplication/VerifyVoteExtension`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static FinalizeBlock(req: RequestFinalizeBlock, initReq?: fm.InitReq): Promise<ResponseFinalizeBlock> {
		return fm.fetchReq<RequestFinalizeBlock, ResponseFinalizeBlock>(`/tendermint.abci.ABCIApplication/FinalizeBlock`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
