...
export class Query {
  ...
  static NextAccountNumber(req: QueryNextAccountNumberRequest, initReq?: fm.InitReq): Promise<QueryNextAccountNumberResponse> {
    return fm.fetchReq<QueryNextAccountNumberRequest, QueryNextAccountNumberResponse>(`/cosmos/auth/v1beta1/nextaccountnumber?${fm.renderURLSearchParams(req, [])}`, {...initReq, method: "GET"})
  }
}