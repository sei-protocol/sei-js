...
export class Msg {
	static CreateValidator(req: MsgCreateValidator, initReq?: fm.InitReq): Promise<MsgCreateValidatorResponse> {
		return fm.fetchReq<MsgCreateValidator, MsgCreateValidatorResponse>(`/cosmos.staking.v1beta1.Msg/CreateValidator`, {
			...initReq,
			method: "POST",
	...
	static EditValidator(req: MsgEditValidator, initReq?: fm.InitReq): Promise<MsgEditValidatorResponse> {
		return fm.fetchReq<MsgEditValidator, MsgEditValidatorResponse>(`/cosmos.staking.v1beta1.Msg/EditValidator`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static Delegate(req: MsgDelegate, initReq?: fm.InitReq): Promise<MsgDelegateResponse> {
		return fm.fetchReq<MsgDelegate, MsgDelegateResponse>(`/cosmos.staking.v1beta1.Msg/Delegate`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static BeginRedelegate(req: MsgBeginRedelegate, initReq?: fm.InitReq): Promise<MsgBeginRedelegateResponse> {
		return fm.fetchReq<MsgBeginRedelegate, MsgBeginRedelegateResponse>(`/cosmos.staking.v1beta1.Msg/BeginRedelegate`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static Undelegate(req: MsgUndelegate, initReq?: fm.InitReq): Promise<MsgUndelegateResponse> {
		return fm.fetchReq<MsgUndelegate, MsgUndelegateResponse>(`/cosmos.staking.v1beta1.Msg/Undelegate`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
