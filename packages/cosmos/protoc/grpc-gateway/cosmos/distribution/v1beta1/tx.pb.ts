...
export class Msg {
	static SetWithdrawAddress(req: MsgSetWithdrawAddress, initReq?: fm.InitReq): Promise<MsgSetWithdrawAddressResponse> {
		return fm.fetchReq<MsgSetWithdrawAddress, MsgSetWithdrawAddressResponse>(`/cosmos.distribution.v1beta1.Msg/SetWithdrawAddress`, {
			...initReq,
			method: "POST",
	...
	static WithdrawDelegatorReward(req: MsgWithdrawDelegatorReward, initReq?: fm.InitReq): Promise<MsgWithdrawDelegatorRewardResponse> {
		return fm.fetchReq<MsgWithdrawDelegatorReward, MsgWithdrawDelegatorRewardResponse>(`/cosmos.distribution.v1beta1.Msg/WithdrawDelegatorReward`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static WithdrawValidatorCommission(req: MsgWithdrawValidatorCommission, initReq?: fm.InitReq): Promise<MsgWithdrawValidatorCommissionResponse> {
		return fm.fetchReq<MsgWithdrawValidatorCommission, MsgWithdrawValidatorCommissionResponse>(`/cosmos.distribution.v1beta1.Msg/WithdrawValidatorCommission`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
	...
	static FundCommunityPool(req: MsgFundCommunityPool, initReq?: fm.InitReq): Promise<MsgFundCommunityPoolResponse> {
		return fm.fetchReq<MsgFundCommunityPool, MsgFundCommunityPoolResponse>(`/cosmos.distribution.v1beta1.Msg/FundCommunityPool`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
