...
export class ReflectionService {
	static GetAuthnDescriptor(req: GetAuthnDescriptorRequest, initReq?: fm.InitReq): Promise<GetAuthnDescriptorResponse> {
		return fm.fetchReq<GetAuthnDescriptorRequest, GetAuthnDescriptorResponse>(
			`/cosmos/base/reflection/v1beta1/app_descriptor/authn?${fm.renderURLSearchParams(req, [])}`,
			{ ...initReq, method: "GET" }
		);
	}
	static GetChainDescriptor(req: GetChainDescriptorRequest, initReq?: fm.InitReq): Promise<GetChainDescriptorResponse> {
		return fm.fetchReq<GetChainDescriptorRequest, GetChainDescriptorResponse>(
			`/cosmos/base/reflection/v1beta1/app_descriptor/chain?${fm.renderURLSearchParams(req, [])}`,
			{ ...initReq, method: "GET" }
		);
	}
	static GetCodecDescriptor(req: GetCodecDescriptorRequest, initReq?: fm.InitReq): Promise<GetCodecDescriptorResponse> {
		return fm.fetchReq<GetCodecDescriptorRequest, GetCodecDescriptorResponse>(
			`/cosmos/base/reflection/v1beta1/app_descriptor/codec?${fm.renderURLSearchParams(req, [])}`,
			{ ...initReq, method: "GET" }
		);
	}
	static GetConfigurationDescriptor(req: GetConfigurationDescriptorRequest, initReq?: fm.InitReq): Promise<GetConfigurationDescriptorResponse> {
		return fm.fetchReq<GetConfigurationDescriptorRequest, GetConfigurationDescriptorResponse>(
			`/cosmos/base/reflection/v1beta1/app_descriptor/configuration?${fm.renderURLSearchParams(req, [])}`,
			{ ...initReq, method: "GET" }
		);
	}
	static GetQueryServicesDescriptor(req: GetQueryServicesDescriptorRequest, initReq?: fm.InitReq): Promise<GetQueryServicesDescriptorResponse> {
		return fm.fetchReq<GetQueryServicesDescriptorRequest, GetQueryServicesDescriptorResponse>(
			`/cosmos/base/reflection/v1beta1/app_descriptor/query_services?${fm.renderURLSearchParams(req, [])}`,
			{ ...initReq, method: "GET" }
		);
	}
	static GetTxDescriptor(req: GetTxDescriptorRequest, initReq?: fm.InitReq): Promise<GetTxDescriptorResponse> {
		return fm.fetchReq<GetTxDescriptorRequest, GetTxDescriptorResponse>(
			`/cosmos/base/reflection/v1beta1/app_descriptor/tx_descriptor?${fm.renderURLSearchParams(req, [])}`,
			{ ...initReq, method: "GET" }
		);
	}
}
