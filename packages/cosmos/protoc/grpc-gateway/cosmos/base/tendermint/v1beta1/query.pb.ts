...
export type GetNodeInfoResponse = {
	default_node_info?: TendermintP2pTypes.NodeInfo;
...
export class Service {
	static GetNodeInfo(req: GetNodeInfoRequest, initReq?: fm.InitReq): Promise<GetNodeInfoResponse> {
		return fm.fetchReq<GetNodeInfoRequest, GetNodeInfoResponse>(`/cosmos/base/tendermint/v1beta1/node_info?${fm.renderURLSearchParams(req, [])}`, {
			...initReq,
			method: "GET"
		});
	}
	static GetSyncing(req: GetSyncingRequest, initReq?: fm.InitReq): Promise<GetSyncingResponse> {
		return fm.fetchReq<GetSyncingRequest, GetSyncingResponse>(`/cosmos/base/tendermint/v1beta1/syncing?${fm.renderURLSearchParams(req, [])}`, {
			...initReq,
			method: "GET"
		});
	}
	static GetLatestBlock(req: GetLatestBlockRequest, initReq?: fm.InitReq): Promise<GetLatestBlockResponse> {
		return fm.fetchReq<GetLatestBlockRequest, GetLatestBlockResponse>(`/cosmos/base/tendermint/v1beta1/blocks/latest?${fm.renderURLSearchParams(req, [])}`, {
			...initReq,
			method: "GET"
		});
	}
	static GetBlockByHeight(req: GetBlockByHeightRequest, initReq?: fm.InitReq): Promise<GetBlockByHeightResponse> {
		return fm.fetchReq<GetBlockByHeightRequest, GetBlockByHeightResponse>(
			`/cosmos/base/tendermint/v1beta1/blocks/${req["height"]}?${fm.renderURLSearchParams(req, ["height"])}`,
			{ ...initReq, method: "GET" }
		);
	}
	static GetLatestValidatorSet(req: GetLatestValidatorSetRequest, initReq?: fm.InitReq): Promise<GetLatestValidatorSetResponse> {
		return fm.fetchReq<GetLatestValidatorSetRequest, GetLatestValidatorSetResponse>(
			`/cosmos/base/tendermint/v1beta1/validatorsets/latest?${fm.renderURLSearchParams(req, [])}`,
			{ ...initReq, method: "GET" }
		);
	}
	static GetValidatorSetByHeight(req: GetValidatorSetByHeightRequest, initReq?: fm.InitReq): Promise<GetValidatorSetByHeightResponse> {
		return fm.fetchReq<GetValidatorSetByHeightRequest, GetValidatorSetByHeightResponse>(
			`/cosmos/base/tendermint/v1beta1/validatorsets/${req["height"]}?${fm.renderURLSearchParams(req, ["height"])}`,
			{ ...initReq, method: "GET" }
		);
	}
}
