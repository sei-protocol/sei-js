...
export class Msg {
	static AggregateExchangeRateVote(req: MsgAggregateExchangeRateVote, initReq?: fm.InitReq): Promise<MsgAggregateExchangeRateVoteResponse> {
		return fm.fetchReq<MsgAggregateExchangeRateVote, MsgAggregateExchangeRateVoteResponse>(`/seiprotocol.seichain.oracle.Msg/AggregateExchangeRateVote`, {
			...initReq,
			method: "POST",
	...
	static DelegateFeedConsent(req: MsgDelegateFeedConsent, initReq?: fm.InitReq): Promise<MsgDelegateFeedConsentResponse> {
		return fm.fetchReq<MsgDelegateFeedConsent, MsgDelegateFeedConsentResponse>(`/seiprotocol.seichain.oracle.Msg/DelegateFeedConsent`, {
			...initReq,
			method: "POST",
			body: JSON.stringify(req, fm.replacer)
		});
