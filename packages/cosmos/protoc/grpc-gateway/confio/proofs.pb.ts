...
export type BatchEntry = BaseBatchEntry & OneOf<{ exist: ExistenceProof; nonexist: NonExistenceProof }>;
...
export type CompressedBatchEntry = BaseCompressedBatchEntry & OneOf<{ exist: CompressedExistenceProof; nonexist: CompressedNonExistenceProof }>;
