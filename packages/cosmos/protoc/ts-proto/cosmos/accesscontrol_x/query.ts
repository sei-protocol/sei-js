...
> = {
  ...
  create<I extends Exact<DeepPartial<ResourceDependencyMappingFromMessageKeyRequest>, I>>(
    base?: I,
  ): ResourceDependencyMappingFromMessageKeyRequest {
    return ResourceDependencyMappingFromMessageKeyRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ResourceDependencyMappingFromMessageKeyRequest>, I>>(
    object: I,
  ): ResourceDependencyMappingFromMessageKeyRequest {
    const message = createBaseResourceDependencyMappingFromMessageKeyRequest();
...
> = {
  ...
  fromJSON(object: any): ResourceDependencyMappingFromMessageKeyResponse {
    return {
      message_dependency_mapping: isSet(object.message_dependency_mapping)
        ? MessageDependencyMapping.fromJSON(object.message_dependency_mapping)
        : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<ResourceDependencyMappingFromMessageKeyResponse>, I>>(
    base?: I,
  ): ResourceDependencyMappingFromMessageKeyResponse {
    return ResourceDependencyMappingFromMessageKeyResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ResourceDependencyMappingFromMessageKeyResponse>, I>>(
    object: I,
  ): ResourceDependencyMappingFromMessageKeyResponse {
    const message = createBaseResourceDependencyMappingFromMessageKeyResponse();
...
export const WasmDependencyMappingRequest: MessageFns<
...
export const WasmDependencyMappingResponse: MessageFns<
...
> = {
  ...
  fromJSON(object: any): WasmDependencyMappingResponse {
    return {
      wasm_dependency_mapping: isSet(object.wasm_dependency_mapping)
        ? WasmDependencyMapping.fromJSON(object.wasm_dependency_mapping)
        : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<WasmDependencyMappingResponse>, I>>(
    object: I,
  ): WasmDependencyMappingResponse {
    const message = createBaseWasmDependencyMappingResponse();
...
> = {
  ...
  create<I extends Exact<DeepPartial<ListResourceDependencyMappingRequest>, I>>(
    base?: I,
  ): ListResourceDependencyMappingRequest {
    return ListResourceDependencyMappingRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ListResourceDependencyMappingRequest>, I>>(
    _: I,
  ): ListResourceDependencyMappingRequest {
    const message = createBaseListResourceDependencyMappingRequest();
    return message;
...
> = {
  ...
  toJSON(message: ListResourceDependencyMappingResponse): unknown {
    ...
    if (message.message_dependency_mapping_list?.length) {
      obj.message_dependency_mapping_list = message.message_dependency_mapping_list.map((e) =>
  ...
  create<I extends Exact<DeepPartial<ListResourceDependencyMappingResponse>, I>>(
    base?: I,
  ): ListResourceDependencyMappingResponse {
    return ListResourceDependencyMappingResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ListResourceDependencyMappingResponse>, I>>(
    object: I,
  ): ListResourceDependencyMappingResponse {
    const message = createBaseListResourceDependencyMappingResponse();
    message.message_dependency_mapping_list =
      object.message_dependency_mapping_list?.map((e) => MessageDependencyMapping.fromPartial(e)) || [];
    return message;
  },
};
...
export const ListWasmDependencyMappingRequest: MessageFns<
...
> = {
  ...
  create<I extends Exact<DeepPartial<ListWasmDependencyMappingRequest>, I>>(
    base?: I,
  ): ListWasmDependencyMappingRequest {
    return ListWasmDependencyMappingRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ListWasmDependencyMappingRequest>, I>>(
    _: I,
  ): ListWasmDependencyMappingRequest {
    const message = createBaseListWasmDependencyMappingRequest();
    return message;
...
> = {
  ...
  toJSON(message: ListWasmDependencyMappingResponse): unknown {
    ...
    if (message.wasm_dependency_mapping_list?.length) {
      obj.wasm_dependency_mapping_list = message.wasm_dependency_mapping_list.map((e) =>
        WasmDependencyMapping.toJSON(e)
      );
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<ListWasmDependencyMappingResponse>, I>>(
    base?: I,
  ): ListWasmDependencyMappingResponse {
    return ListWasmDependencyMappingResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ListWasmDependencyMappingResponse>, I>>(
    object: I,
  ): ListWasmDependencyMappingResponse {
    const message = createBaseListWasmDependencyMappingResponse();
    message.wasm_dependency_mapping_list =
      object.wasm_dependency_mapping_list?.map((e) => WasmDependencyMapping.fromPartial(e)) || [];
    return message;
  },
};
