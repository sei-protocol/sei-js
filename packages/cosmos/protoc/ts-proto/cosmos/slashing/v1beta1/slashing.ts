...
> = {
  ...
  create<I extends Exact<DeepPartial<ValidatorSigningInfoLegacyMissedHeights>, I>>(
    base?: I,
  ): ValidatorSigningInfoLegacyMissedHeights {
    return ValidatorSigningInfoLegacyMissedHeights.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ValidatorSigningInfoLegacyMissedHeights>, I>>(
    object: I,
  ): ValidatorSigningInfoLegacyMissedHeights {
    const message = createBaseValidatorSigningInfoLegacyMissedHeights();
...
> = {
  ...
  fromJSON(object: any): ValidatorMissedBlockArrayLegacyMissedHeights {
    return {
      address: isSet(object.address) ? globalThis.String(object.address) : "",
      missed_heights: globalThis.Array.isArray(object?.missed_heights)
        ? object.missed_heights.map((e: any) => globalThis.Number(e))
        : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<ValidatorMissedBlockArrayLegacyMissedHeights>, I>>(
    base?: I,
  ): ValidatorMissedBlockArrayLegacyMissedHeights {
    return ValidatorMissedBlockArrayLegacyMissedHeights.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ValidatorMissedBlockArrayLegacyMissedHeights>, I>>(
    object: I,
  ): ValidatorMissedBlockArrayLegacyMissedHeights {
    const message = createBaseValidatorMissedBlockArrayLegacyMissedHeights();
    message.address = object.address ?? "";
...
export const ValidatorMissedBlockArray: MessageFns<
  ...
  fromJSON(object: any): ValidatorMissedBlockArray {
    return {
      ...
      missed_blocks: globalThis.Array.isArray(object?.missed_blocks)
        ? object.missed_blocks.map((e: any) => globalThis.Number(e))
        : [],
    };
  },
