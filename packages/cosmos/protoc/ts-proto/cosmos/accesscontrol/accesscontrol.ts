...
export const WasmContractReference: MessageFns<
...
> = {
  ...
  fromJSON(object: any): WasmContractReference {
    return {
      ...
      json_translation_template: isSet(object.json_translation_template)
        ? globalThis.String(object.json_translation_template)
        : "",
    };
  },
...
export const WasmContractReferences: MessageFns<
...
export const WasmAccessOperations: MessageFns<
...
> = {
  ...
  fromJSON(object: any): WasmAccessOperations {
    return {
      message_name: isSet(object.message_name) ? globalThis.String(object.message_name) : "",
      wasm_operations: globalThis.Array.isArray(object?.wasm_operations)
        ? object.wasm_operations.map((e: any) => WasmAccessOperation.fromJSON(e))
        : [],
    };
  },
...
export const MessageDependencyMapping: MessageFns<
  ...
  fromJSON(object: any): MessageDependencyMapping {
    return {
      ...
      access_ops: globalThis.Array.isArray(object?.access_ops)
        ? object.access_ops.map((e: any) => AccessOperation.fromJSON(e))
        : [],
...
export const WasmDependencyMapping: MessageFns<
...
> = {
  ...
  fromJSON(object: any): WasmDependencyMapping {
    return {
      base_access_ops: globalThis.Array.isArray(object?.base_access_ops)
        ? object.base_access_ops.map((e: any) => WasmAccessOperation.fromJSON(e))
        : [],
      query_access_ops: globalThis.Array.isArray(object?.query_access_ops)
        ? object.query_access_ops.map((e: any) => WasmAccessOperations.fromJSON(e))
        : [],
  ...
  toJSON(message: WasmDependencyMapping): unknown {
    ...
    if (message.execute_contract_references?.length) {
      obj.execute_contract_references = message.execute_contract_references.map((e) =>
        WasmContractReferences.toJSON(e)
      );
    }
    if (message.reset_reason !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<WasmDependencyMapping>, I>>(object: I): WasmDependencyMapping {
    ...
    message.base_contract_references =
      object.base_contract_references?.map((e) => WasmContractReference.fromPartial(e)) || [];
    message.query_contract_references =
      object.query_contract_references?.map((e) => WasmContractReferences.fromPartial(e)) || [];
    message.execute_contract_references =
      object.execute_contract_references?.map((e) => WasmContractReferences.fromPartial(e)) || [];
