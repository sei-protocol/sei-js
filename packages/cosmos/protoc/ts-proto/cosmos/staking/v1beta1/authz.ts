...
export const StakeAuthorization: MessageFns<StakeAuthorization, "cosmos.staking.v1beta1.StakeAuthorization"> = {
  ...
  fromPartial<I extends Exact<DeepPartial<StakeAuthorization>, I>>(object: I): StakeAuthorization {
    ...
    message.allow_list = (object.allow_list !== undefined && object.allow_list !== null)
      ? StakeAuthorizationValidators.fromPartial(object.allow_list)
      : undefined;
    message.deny_list = (object.deny_list !== undefined && object.deny_list !== null)
      ? StakeAuthorizationValidators.fromPartial(object.deny_list)
      : undefined;
...
export const StakeAuthorizationValidators: MessageFns<
  StakeAuthorizationValidators,
