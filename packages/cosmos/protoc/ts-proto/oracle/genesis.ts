...
export const GenesisState: MessageFns<GenesisState, "seiprotocol.seichain.oracle.GenesisState"> = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      feeder_delegations: globalThis.Array.isArray(object?.feeder_delegations)
      ...
      exchange_rates: globalThis.Array.isArray(object?.exchange_rates)
        ...
        : [],
      penalty_counters: globalThis.Array.isArray(object?.penalty_counters)
        ? object.penalty_counters.map((e: any) => PenaltyCounter.fromJSON(e))
        : [],
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.aggregate_exchange_rate_votes?.length) {
      obj.aggregate_exchange_rate_votes = message.aggregate_exchange_rate_votes.map((e) =>
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.aggregate_exchange_rate_votes =
      object.aggregate_exchange_rate_votes?.map((e) => AggregateExchangeRateVote.fromPartial(e)) || [];
