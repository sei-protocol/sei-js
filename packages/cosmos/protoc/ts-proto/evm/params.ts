...
export const Params: MessageFns<Params, "seiprotocol.seichain.evm.Params"> = {
  ...
  fromJSON(object: any): Params {
    return {
      ...
      whitelisted_cw_code_hashes_for_delegate_call:
        globalThis.Array.isArray(object?.whitelisted_cw_code_hashes_for_delegate_call)
          ? object.whitelisted_cw_code_hashes_for_delegate_call.map((e: any) => bytesFromBase64(e))
          : [],
      deliver_tx_hook_wasm_gas_limit: isSet(object.deliver_tx_hook_wasm_gas_limit)
      ...
      max_dynamic_base_fee_downward_adjustment: isSet(object.max_dynamic_base_fee_downward_adjustment)
        ...
        : "",
      target_gas_used_per_block: isSet(object.target_gas_used_per_block)
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.whitelisted_cw_code_hashes_for_delegate_call?.length) {
      obj.whitelisted_cw_code_hashes_for_delegate_call = message.whitelisted_cw_code_hashes_for_delegate_call.map((e) =>
        base64FromBytes(e)
      );
    }
    if (message.deliver_tx_hook_wasm_gas_limit !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    message.whitelisted_cw_code_hashes_for_delegate_call =
      object.whitelisted_cw_code_hashes_for_delegate_call?.map((e) => e) || [];
